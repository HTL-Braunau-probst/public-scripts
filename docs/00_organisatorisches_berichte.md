...
Beachtet, dass der Link zu Angabe nicht mehr verfügbar ist. Selbst dann sollte klar sein, was die Aufgabe war.


Pro Teams Zuweisung ein Dokument, **im PDF Format**
...
- Muss in der Übung etwas ausgeführt werden, dann muss dies auch in der Ausgabe enthalten sein.
  - Die Ausgaben sind **vorzugsweise als Text** dabei. Es sind aber auch Screenshots erlaubt.
  - Sind mehere Ausführungen notwendig sind sie dokumentiert.
  - Die Ausgaben sollen kurz analysiert werden.
- Wird KI verwendet, soll dies im Bericht vermerkt werden, wo/wie dies der Fall war.
